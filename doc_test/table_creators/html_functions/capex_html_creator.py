...
def convert_xlsx_to_html(excel_path, output_html_path):
    """CAPEX Excel dosyasını alır ve birebir HTML'e çevirir."""
...
def process_capex_html():
    """Yalnızca capex.xlsx dosyasını hedef alıp capex.html üretir."""
    base_dir = os.path.dirname(os.path.abspath(__file__))

    excel_path = os.path.join(base_dir, "..", "tables", "xlsx1", "capex.xlsx")
    output_html_path = os.path.join(base_dir, "..", "tables", "htmls", "capex.html")
    ...
    try:
        ...
        print("  ✅ CAPEX HTML Dönüşümü Başarılı: capex.xlsx -> capex.html")
    except Exception as e:
        print(f"  ❌ CAPEX HTML Dönüşüm Hatası: {e}")

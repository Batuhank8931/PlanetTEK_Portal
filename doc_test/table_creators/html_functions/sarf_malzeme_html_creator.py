...
def convert_xlsx_to_html(excel_path, output_html_path):
    """Özet Tablosu Excel dosyasını alır ve birebir HTML'e çevirir."""
...
def process_sarf_malzeme_html():
    """Yalnızca sarf_malzeme.xlsx dosyasını hedef alıp sarf_malzeme.html üretir."""
    base_dir = os.path.dirname(os.path.abspath(__file__))

    if os.path.exists("sarf_malzeme.xlsx"):
        excel_path = os.path.abspath("sarf_malzeme.xlsx")
        os.makedirs(os.path.join(base_dir, "tables", "htmls"), exist_ok=True)
        output_html_path = os.path.join(
            base_dir, "tables", "htmls", "sarf_malzeme.html"
        )
    else:
        excel_path = os.path.join(
            base_dir, "..", "tables", "xlsx1", "sarf_malzeme.xlsx"
        )
        output_html_path = os.path.join(
            base_dir, "..", "tables", "htmls", "sarf_malzeme.html"
        )
    ...
    if not os.path.exists(excel_path):
        excel_path = "sarf_malzeme.xlsx"
        output_html_path = "sarf_malzeme.html"

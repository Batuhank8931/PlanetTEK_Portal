...
def get_kapak_row_count(html_path):
    """kapak.html dosyasındaki tr (satır) sayısını sayar."""
...
def clear_after_kapak():
    """
    ##clear_after_kapak## etiketini bulur ve Kapak tablosunda eklenen satır sayısı kadar
    ...
    row_count = get_kapak_row_count(kapak_html_path)
    print(f"📊 Kapak tablosundaki satır sayısı: {row_count}")

...
def html_to_word_karbon_ayakizi_table(html_content, doc):
    """Karbon Ayakizi HTML tablosunu 6 sütunlu yapısıyla ve tam genişlikte Word'e aktarır."""
    ...
    # 6 Sütun için orantılı genişlikler (Toplam ~6.5 inç A4 net alan)
    col_widths = [
        Inches(1.80),  # Açıklama / Sol taraf
        Inches(0.85),  # Değer 1
        Inches(1.00),  # Birim 1
        Inches(1.80),  # Açıklama / Sağ taraf
        Inches(0.85),  # Değer 2
        Inches(1.00),  # Birim 2
    ]
    ...
    for r_idx, tr in enumerate(rows):
        ...
        for td in cells:
            ...
            # Font boyutu (Ağaç sayısı için olan 22pt gibi büyük fontları korur)

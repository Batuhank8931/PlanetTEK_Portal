...
def convert_xlsx_to_html(excel_path, output_html_path):
    """Parametre Excel dosyasını (parametre.xlsx) alır ve birebir HTML'e çevirir."""
    ...
    html.append(
        "  td { padding: 4px 6px; word-wrap: break-word; vertical-align: middle; }"
    )
...
def process_parametre_html():
    """Yalnızca parametre.xlsx dosyasını hedef alıp parametre.html üretir."""
    base_dir = os.path.dirname(os.path.abspath(__file__))

    excel_path = os.path.join(base_dir, "..", "tables", "xlsx1", "parametre.xlsx")
    output_html_path = os.path.join(base_dir, "..", "tables", "htmls", "parametre.html")
    ...
    try:
        ...
        print("  ✅ PARAMETRE HTML Dönüşümü Başarılı: parametre.xlsx -> parametre.html")
    except Exception as e:
        print(f"  ❌ PARAMETRE HTML Dönüşüm Hatası: {e}")


if __name__ == "__main__":
    process_parametre_html()

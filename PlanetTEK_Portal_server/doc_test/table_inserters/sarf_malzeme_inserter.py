...
def html_to_word_sarf_table(html_content, doc):
    """Sarf Malzeme HTML tablosunu dxa/tblGrid seviyesinde tam genişlikte Word'e aktarır."""
    ...
    # 5 Sütun Orantılı Genişlikleri
    col_widths_inches = [2.15, 1.10, 1.35, 0.95, 1.20]

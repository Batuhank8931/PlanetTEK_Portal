...
def html_to_word_parametre_table(html_content, doc):
    """Parametre HTML tablosunu dxa/tblGrid seviyesinde 4 sütunlu yapıda oluşturur ve LibreOffice büzüşmelerini engeller."""
    ...
    # 4 Sütun Orantılı Genişlikleri (2.8", 0.8", 1.2", 1.2" | Toplam: 6.0 inç / 8640 dxa)
    col_widths_inches = [2.80, 0.80, 1.20, 1.20]
    ...
    for r_idx, tr in enumerate(rows):
        ...
        # Satırların Sayfa Bölünmesinde Kırılmasını Engelle (cantSplit)

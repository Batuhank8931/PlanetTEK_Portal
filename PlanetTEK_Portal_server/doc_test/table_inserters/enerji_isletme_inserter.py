...
def html_to_word_enerji_table(html_content, doc):
    """Enerji İşletme HTML tablosunu dxa/tblGrid seviyesinde tam genişlikte Word'e aktarır."""
    ...
    # 8 Sütun Orantılı Genişlikleri (Toplam 6.5 inç / 9360 dxa A4 Net Yazdırma Alanı)
    col_widths_inches = [1.70, 0.60, 0.40, 0.75, 0.75, 0.75, 0.75, 0.80]

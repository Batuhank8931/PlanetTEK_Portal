...
def html_to_word_capex_table(html_content, doc):
    """CAPEX HTML tablosunu dxa/tblGrid seviyesinde tam genişlikte Word'e aktarır."""
    ...
    # CAPEX Tablosu Özel A4 Sütun Genişlikleri (Toplam 6.5 inç / 9360 dxa)
    col_widths_inches = [0.45, 2.35, 0.50, 0.80, 0.85, 0.65, 0.90]

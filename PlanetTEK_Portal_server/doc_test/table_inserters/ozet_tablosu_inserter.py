...
def html_to_word_ozet_tablosu_table(html_content, doc):
    """Özet Tablosu HTML tablosunu dxa/tblGrid seviyesinde tam genişlikte Word'e aktarır."""
    ...
    # 6 Sütun Orantılı Genişlikleri (Toplam ~6.5 inç / 9360 dxa A4 Net Yazdırma Alanı)
    col_widths_inches = [0.35, 0.70, 1.00, 2.20, 1.60, 0.65]

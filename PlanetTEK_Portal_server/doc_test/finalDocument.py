...
def replace_placeholders_in_doc(doc, replacements):
    """Word belgesindeki font ve stil biçimlendirmelerini bozmadan placeholder
    metinlerini değiştirir.
    """
...
def prepare_final_document():
    ...
    final_dir = os.path.join(base_dir, "final_offer")
    ...
    delivery1 = customer_info.get("##delivery1##", "")
    delivery2 = customer_info.get("##delivery2##", "")
    delivery3 = customer_info.get("##delivery3##", "")
    delivery4 = customer_info.get("##delivery4##", "")
    ...
    # 6. Dosya Adı ve Klasör Oluşturma
    ...
    safe_offer_folder = re.sub(r'[\\/*?:"<>|]', "", folder_name_raw)

    target_dir = os.path.join(final_dir, safe_offer_folder)
    ...
    try:
        ...
        print(f"Klasör Oluşturuldu/Kullanıldı: {target_dir}")

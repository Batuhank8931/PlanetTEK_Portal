...
function KarbonAyakiziTablosu() {
  ...
  // Karbon ayak izi ve enerji tüketim metrikleri
  const [data, setData] = useState({
    co2Factor: 0.43, // Türkiye veya Avrupa için ortalama şebeke emisyon faktörü (kg CO₂/kWh)
    planet: { dailyKwh: 64.6 }, // PlanetDISK günlük enerji tüketimi
    aktif_camur: { dailyKwh: 345.5 }, // Aktif Çamur günlük enerji tüketimi
    mbbr: { dailyKwh: 285.0 }, // MBBR günlük enerji tüketimi
  });
  ...
  const planetCo2 = (planetYearlyKwh * data.co2Factor) / 1000; // ton CO₂
  ...
  const altCo2 = (altYearlyKwh * data.co2Factor) / 1000; // ton CO₂

  const savedCo2 = altCo2 - planetCo2;
  // Görsel zenginlik: 1 yetişkin ağaç yılda ortalama 22 kg CO2 emer.
  ...
  return (
    <div className="d-flex flex-column gap-3 w-100 text-white">
      ...
      {/* ÜST PANEL: SİSTEM SEÇİMİ VE GERİ AL */}
      ...
      <div className="d-flex flex-column rounded-3 overflow-hidden" style={{ border: "1px solid #334155", backgroundColor: "#151f32" }}>
        ...
        {/* SATIR 1: GÜNLÜK ENERJİ TÜKETİMİ */}
        ...
        {/* SATIR 2: YILLIK ENERJİ TÜKETİMİ (OTOMATİK HESAPLANIR) */}
        ...
        {/* SATIR 3: ŞEBEKE EMİSYON FAKTÖRÜ */}
        ...
        {/* SATIR 4: YILLIK CO2 SALINIMI ÖZETİ */}
      ...
      {/* ALT PANEL: ÇEVRESEL KAZANÇ RAPORU */}

  ...
  return (
    <div className="d-flex flex-column gap-3 w-100 text-white">
      ...
      <style>{`
        ...
        .comp-input { font-size: 13px; box-shadow: none; width: 90px; border-bottom: 1px dashed #475569 !important; }
        ...
        <div className="d-flex flex-column align-items-center justify-content-center text-center">
          ...
          {data.inflationRate > 0 && (
            <span className="text-white-50 mt-2" style={{ fontSize: "11px" }}>
              * Hesaplamalara 10 yıllık işletme süresince yıllık <strong>%{data.inflationRate}</strong> enflasyon dahil edilmiştir.
            </span>
          )}
        </div>
      </div>

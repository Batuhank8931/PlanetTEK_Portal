...
function EnerjiKarsilastirmaTablosu() {
  ...
  // --- MATEMATİKSEL METRİKLER VE ARA HESAPLAMALAR ---
  ...
  return (
    <div className="d-flex flex-column gap-3 w-100 text-white">
      ...
      <div className="d-flex flex-column rounded-3 overflow-hidden" style={{ border: "1px solid #334155", backgroundColor: "#151f32" }}>
        ...
        {/* SATIR 3: TOPLAM GÜÇ - OTOMATİK HESAPLANIR */}
        ...
        {/* SATIR 5: GERÇEK KULLANILAN GÜÇ - OTOMATİK HESAPLANIR */}
        <div className="d-flex align-items-stretch comp-row font-monospace text-white" style={{ fontSize: "12px" }}>
        ...
        {/* SATIR 7: GÜNLÜK ÇALIŞMA SÜRELERİ */}
        <div className="d-flex align-items-stretch comp-row">
        ...
        {/* SATIR 8: YILLIK ENERJİ TÜKETİM MALİYET ÖZETLERİ */}
      ...
      {/* ALT PANEL: FARK VE TOPLAM EKONOMİK KAZANÇ RAPORU (Görseldeki Kırmızı Büyük Alanlar) */}
      <div className="d-flex flex-column rounded-3 overflow-hidden border p-3 gap-2" style={{ borderColor: "#475569", backgroundColor: "#090d16" }}>
        ...
        {/* BÜYÜK YAKLAŞIK TOPLAM KAZANÇ ALANI (Bakım & Difüzör Değişim Kârı Dahil) */}
